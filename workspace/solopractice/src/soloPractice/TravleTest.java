...
public class TravleTest {
	...
	public static void main(String[] args) {
		...
		if(insertMessage==1) {
			System.out.println(oceanMessage);
		}else if(insertMessage==2){
			System.out.println(mountainMessage);
		}else if(insertMessage==3) {
			System.out.println(cityMessage);
		}else if(insertMessage==4) {
			System.out.println(countrysideMessage);
		}else {
